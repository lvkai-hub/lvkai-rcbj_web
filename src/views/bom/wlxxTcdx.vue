<template>
  <div class="app-container">
    <el-dialog title="物料信息" :visible.sync="dialogWlxxdx" width="80%" :close-on-click-modal="false" :show-close='false'>
      ...
      <el-table v-loading="loading" :data="wlxxList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="创建人" align="center" prop="cjrxh" />
        <el-table-column label="创建时间" align="center" prop="cjsj" />
        <el-table-column label="修改人" align="center" prop="xgrxh" />
